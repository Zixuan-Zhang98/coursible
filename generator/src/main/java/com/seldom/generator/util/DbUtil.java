package com.seldom.generator.util;
...
public class DbUtil {
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            String url = "jdbc:mysql://localhost:3306/courseimooc?useSSL=false&useUnicode=true&characterEncoding=UTF8&serverTimezone=America/Chicago";
            String user = "root";
            String pass = "zzx123456";
